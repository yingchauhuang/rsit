...
if [ $? -eq 0 ]
then
curl -o USD_Update_web.txt 'http://getmkdata.moneydj.com/getmkdata.aspx?BrokerID=SysJust&A=US'
if [ $? -ne 0 ]
then
export SFTP=1
else
...
sqlldr $Oracle_User/$Oracle_PWD control=US002_web.ctrl
...
#sqlplus -s -l $Oracle:_User/$Oracle_PWD "@After_Import.sql"

#sqlplus -s -l $Oracle_User/$Oracle_PWD "@compute_vol10_.sql"
